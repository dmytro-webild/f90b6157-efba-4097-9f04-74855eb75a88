...
export default function LandingPage() {
      ...
      bulletPoints={[
        {
          ...
          description: "Technology that reflects human history and future potential.",
        },
        {
          title: "Advanced Engineering",
          description: "Built on industry-leading stacks for maximum performance.",
        },
        {
      ...
      features={[
        {
          ...
          description: "Seamlessly integrate generated assets into your pipeline.",
          media: {
        ...
        },
        {
          ...
          description: "Collaborate within our secure digital workspace environments.",
          media: {
        ...
        },
        {
          ...
          description: "Host your masterpieces on globally distributed infrastructures.",
          media: {
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        {
          id: "6",
          name: "SculptMaster Pro",
          price: "$349",
          imageSrc: "http://img.b2bpic.net/free-photo/vr-glasses-cell-phone-wooden-desk_1387-986.jpg",
        },
      ]}
      title="Our Solutions"
      ...
      plans={[
        {
          ...
          price: "$49",
          period: "/mo",
          description: "For individual artists starting out.",
          button: {
            text: "Choose Basic",
          },
        ...
        },
        {
          ...
          price: "$149",
          period: "/mo",
          description: "For power users & studio designers.",
          button: {
            text: "Choose Pro",
          },
        ...
        },
        {
          ...
          price: "$499",
          period: "/mo",
          description: "For enterprise team workflows.",
          button: {
            text: "Contact Us",
          },
      ...
      testimonials={[
        {
          ...
          name: "Sarah Miller",
          handle: "@sarahart",
          testimonial: "The integration is seamless and powerful.",
        ...
        },
        {
          ...
          name: "Marcus Chen",
          handle: "@mchen_studio",
          testimonial: "Finally, a platform that understands our needs.",
        ...
        },
        {
          ...
          handle: "@elena_design",
          testimonial: "Simply the best tech for creative projects.",
        ...
        },
        {
          ...
          name: "David Okafor",
          handle: "@d_okafor",
          testimonial: "High performance and intuitive UI. Highly recommended.",
        ...
        },
        {
          ...
          name: "Jasmine Lee",
          handle: "@jlee_art",
          testimonial: "Changed how I approach digital production forever.",
